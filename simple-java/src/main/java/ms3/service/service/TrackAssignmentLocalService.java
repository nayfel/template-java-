...
/**
 * Provides the local service interface for TrackAssignment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author jackt
 * @see TrackAssignmentLocalServiceUtil
...
public interface TrackAssignmentLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link TrackAssignmentLocalServiceUtil} to access the track assignment local service. Add custom service methods to {@link ms3.service.service.impl.TrackAssignmentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
