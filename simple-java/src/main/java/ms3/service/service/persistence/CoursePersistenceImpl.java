...
import ms3.service.model.impl.CourseImpl;
import ms3.service.model.impl.CourseModelImpl;
...
public class CoursePersistenceImpl extends BasePersistenceImpl<Course>
    ...
    @Override
    public Course updateImpl(ms3.service.model.Course course)
        throws SystemException {
        course = toUnwrappedModel(course);
    ...
    protected Course toUnwrappedModel(Course course) {
        ...
        courseImpl.setEstimatedHours(course.getEstimatedHours());
        courseImpl.setSections(course.getSections());
        courseImpl.setSkills(course.getSkills());
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.ms3.service.model.Course")));
