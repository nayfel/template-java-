...
/**
 * Provides the local service interface for DailyLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author jackt
 * @see DailyLogLocalServiceUtil
...
public interface DailyLogLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link DailyLogLocalServiceUtil} to access the daily log local service. Add custom service methods to {@link ms3.service.service.impl.DailyLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
