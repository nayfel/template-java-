...
import ms3.service.service.TrackAssignmentLocalService;
...
/**
 * Provides the base implementation for the track assignment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ms3.service.service.impl.TrackAssignmentLocalServiceImpl}.
 * </p>
 *
 * @author jackt
 * @see ms3.service.service.impl.TrackAssignmentLocalServiceImpl
 * @see ms3.service.service.TrackAssignmentLocalServiceUtil
 * @generated
 */
public abstract class TrackAssignmentLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements TrackAssignmentLocalService,
        IdentifiableBean {
    ...
    private TrackAssignmentLocalServiceClpInvoker _clpInvoker = new TrackAssignmentLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link ms3.service.service.TrackAssignmentLocalServiceUtil} to access the track assignment local service.
     */
    ...
    @Override
    public TrackAssignment addTrackAssignment(TrackAssignment trackAssignment)
        throws SystemException {
        trackAssignment.setNew(true);

        return trackAssignmentPersistence.update(trackAssignment);
    }
     ...
     */
    @Override
    public TrackAssignment createTrackAssignment(long trackAssignmentId) {
        return trackAssignmentPersistence.create(trackAssignmentId);
    }
    ...
    @Override
    public TrackAssignment deleteTrackAssignment(long trackAssignmentId)
        throws PortalException, SystemException {
        return trackAssignmentPersistence.remove(trackAssignmentId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public TrackAssignment deleteTrackAssignment(
        TrackAssignment trackAssignment) throws SystemException {
        return trackAssignmentPersistence.remove(trackAssignment);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(TrackAssignment.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return trackAssignmentPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return trackAssignmentPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public TrackAssignment fetchTrackAssignment(long trackAssignmentId)
        throws SystemException {
        return trackAssignmentPersistence.fetchByPrimaryKey(trackAssignmentId);
    }
     ...
     */
    @Override
    public TrackAssignment getTrackAssignment(long trackAssignmentId)
        throws PortalException, SystemException {
        return trackAssignmentPersistence.findByPrimaryKey(trackAssignmentId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return trackAssignmentPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<TrackAssignment> getTrackAssignments(int start, int end)
        throws SystemException {
        return trackAssignmentPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getTrackAssignmentsCount() throws SystemException {
        return trackAssignmentPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public TrackAssignment updateTrackAssignment(
        TrackAssignment trackAssignment) throws SystemException {
        return trackAssignmentPersistence.update(trackAssignment);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("ms3.service.model.TrackAssignment",
            trackAssignmentLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = trackAssignmentPersistence.getDataSource();
