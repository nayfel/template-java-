...
import ms3.service.service.TrackAssignmentService;
...
/**
 * Provides the base implementation for the track assignment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ms3.service.service.impl.TrackAssignmentServiceImpl}.
 * </p>
 *
 * @author jackt
 ...
 * @generated
 */
public abstract class TrackAssignmentServiceBaseImpl extends BaseServiceImpl
    implements TrackAssignmentService, IdentifiableBean {
    ...
    private TrackAssignmentServiceClpInvoker _clpInvoker = new TrackAssignmentServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link ms3.service.service.TrackAssignmentServiceUtil} to access the track assignment remote service.
     */
