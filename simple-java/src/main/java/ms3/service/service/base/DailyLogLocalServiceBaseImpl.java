...
import ms3.service.service.DailyLogLocalService;
...
/**
 * Provides the base implementation for the daily log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ms3.service.service.impl.DailyLogLocalServiceImpl}.
 * </p>
 *
 * @author jackt
 * @see ms3.service.service.impl.DailyLogLocalServiceImpl
 * @see ms3.service.service.DailyLogLocalServiceUtil
 * @generated
 */
public abstract class DailyLogLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements DailyLogLocalService, IdentifiableBean {
    ...
    private DailyLogLocalServiceClpInvoker _clpInvoker = new DailyLogLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link ms3.service.service.DailyLogLocalServiceUtil} to access the daily log local service.
     */
    ...
    @Override
    public DailyLog addDailyLog(DailyLog dailyLog) throws SystemException {
        dailyLog.setNew(true);

        return dailyLogPersistence.update(dailyLog);
    }
     ...
     */
    @Override
    public DailyLog createDailyLog(long dailyLogId) {
        return dailyLogPersistence.create(dailyLogId);
    }
    ...
    @Override
    public DailyLog deleteDailyLog(long dailyLogId)
        throws PortalException, SystemException {
        return dailyLogPersistence.remove(dailyLogId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public DailyLog deleteDailyLog(DailyLog dailyLog) throws SystemException {
        return dailyLogPersistence.remove(dailyLog);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(DailyLog.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return dailyLogPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return dailyLogPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return dailyLogPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return dailyLogPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public DailyLog fetchDailyLog(long dailyLogId) throws SystemException {
        return dailyLogPersistence.fetchByPrimaryKey(dailyLogId);
    }
     ...
     */
    @Override
    public DailyLog getDailyLog(long dailyLogId)
        throws PortalException, SystemException {
        return dailyLogPersistence.findByPrimaryKey(dailyLogId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return dailyLogPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<DailyLog> getDailyLogs(int start, int end)
        throws SystemException {
        return dailyLogPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getDailyLogsCount() throws SystemException {
        return dailyLogPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public DailyLog updateDailyLog(DailyLog dailyLog) throws SystemException {
        return dailyLogPersistence.update(dailyLog);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("ms3.service.model.DailyLog",
            dailyLogLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "ms3.service.model.DailyLog");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = dailyLogPersistence.getDataSource();
