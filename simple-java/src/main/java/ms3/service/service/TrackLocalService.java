...
/**
 * Provides the local service interface for Track. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author jackt
 * @see TrackLocalServiceUtil
...
public interface TrackLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link TrackLocalServiceUtil} to access the track local service. Add custom service methods to {@link ms3.service.service.impl.TrackLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
